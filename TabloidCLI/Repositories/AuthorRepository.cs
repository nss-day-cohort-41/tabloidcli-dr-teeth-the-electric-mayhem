...
{
    //public class calling from the AuthorRepository : DatabaseConnector, IRepository<Author>
    public class AuthorRepository : DatabaseConnector, IRepository<Author>
    {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        //adding the information to the author variable
                        authors.Add(author);
                    }
        ...
        // Method that is going to be returning "Author" data, searching by id number
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        //displaying the tag id
                        if (!reader.IsDBNull(reader.GetOrdinal("TagId")))
                        {
                            //method that adds tags to author
